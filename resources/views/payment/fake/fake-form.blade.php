...
<head>
    ...
    ?>
  <meta charset="UTF-8">
  <title>test Wallet - Recharge</title>
...
<div class="iphone">
  ...
  <form action="{{url('api/v1/operations/recharge-wallet-requests/callback/'.$data->gen_code)}}" class="form" method="GET">
    <div>
      ...
      <table>
        <tbody>
          <tr>
            ...
            <td align="right">AED {{number_format($data->amount ,0)}}</td>
          </tr>
          <tr>
            <td>VAT 5%</td>
            <td align="right">AED {{number_format($data->amount*0.05 ,0)}}</td>
          </tr>
        ...
        <tfoot>
          <tr>
            <td>Total</td>
            <td align="right">AED {{number_format($data->amount + $data->amount*0.05 ,0)}}</td>
          </tr>
        </tfoot>
      </table>
    </div>
