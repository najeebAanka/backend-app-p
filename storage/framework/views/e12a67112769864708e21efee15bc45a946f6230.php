...
<?php echo $__env->make('dashboard.shared.side-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
  <main id="main" class="main">
    ...
    <div class="bg-trans p-2">
      ...
      <a  href="<?php echo e(url('auctions/'.$auction->id)); ?>" class="btn btn-warning m-1" style="float: right" >
        ...
        if($u->winner_type == 'user'){
           ...
           $name = "Hall bidder (". $u->winner_id.")";
                  ...
                  <table class="table table-bordered bg-white mb-5">
                    ...
                    <a style="font-size: 12px" href="<?php echo e(url('horse-details/'.$horse->id)); ?>?redirected=auction&auction_id=<?php echo e($auction->id); ?>">More details</a>
                          
                          
                          </td>
                          <td><?php echo e($lot->order_sn+1); ?></td>
                          <td><?php echo e($horse->owner_name); ?></td>
                          <td><?php echo e($a->amount); ?> <?php echo e($a->currency); ?></td>
                      </tr>
                      <?php } ?>
                      <tr>
                          <td colspan="100%">
                              
                                   <form method="get" target="blank" action="<?php echo e(url('remote-operations/invoices/generate-lots-winner-invoice/'.$u->winner_id.'/'.$u->winner_type.'/'.$auction->id)); ?>">
                      ...
                      <tr>
                          <td colspan="100%">
                              ...
                              <div class="p-3" style="background-color: #f9f9f9">
                                  <a class="btn btn-link btn-sm" href="<?php echo e(url('remote-operations/invoices/view/'.$i->id)); ?>" style="float: right">View</a>
                                  
                              <p  ><?php echo e($i->gen_id); ?></p>
                              <?php if($email!=""): ?>
                                 <form method="post" action="<?php echo e(url('remote-operations/invoices/email-lots-winner-invoice/'.$i->id)); ?>">
                            <?php echo e(csrf_field()); ?>

                                     <table class="table table-bordered">
                                         <tr>
                                             <td> <p  >Email invoice </p> </td>
                                             <td><input   type="email" name="email" value=" <?php echo e($email); ?>" class="form-control" /></td>
                              ...
                              foreach ( $hist as $h){ ?>
                                  <li>Sent to <?php echo e($h->email); ?> at  <?php echo e($h->created_at); ?></li>
                              <?php } ?>
                                  </ul>
                              </div>
                                      <?php } ?>
...
</html><?php /**PATH C:\wamp64\www\test\resources\views/dashboard/pages/auction-report.blade.php ENDPATH**/ ?>