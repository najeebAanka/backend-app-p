...
<head>
  ...
  <title>Dashboard - <?php echo e($horse->name_en); ?></title>
 <?php    $request = request(); 
...
<?php echo $__env->make('dashboard.shared.side-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
  ...
  <div class="bg-trans p-2">
    ...
    padding: 1rem;">Status : <b><?php echo e(strtoupper($horse->status)); ?></b> | <a href="<?php echo e(url('horse-timeline/'.$horse->id)); ?>">Check timeline</a> 
          |  <a href="<?php echo e(url('horse-pedigree/'.$horse->id)); ?>">Check full pedigree</a></span>
      
    <div class="pagetitle">
      <h1><?php echo e($horse->name_en); ?></h1>
      <nav>
        <ol class="breadcrumb">
          ...
          <?php if($request->has('redirected') && $request->redirected == 'auction'){
              ...
              ?>
           <li class="breadcrumb-item"><a href="<?php echo e(url('auctions/'.$request->auction_id)); ?>"><?php echo e($a->name); ?></a></li>
          <?php
              
          }else{ ?>
           <li class="breadcrumb-item"><a href="<?php echo e(url('horses')); ?>">Horses</a></li>
          <?php } ?>
          <li class="breadcrumb-item active"><?php echo e($horse->name_en); ?></li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
  </div>
    <section class="section dashboard">
      ...
      <div class="row">
          ...
          <div class="col-md-6">
              ...
              <div class="card  p-2" >
                    <form method="post" action="<?php echo e(url('operations/horses/update')); ?>" enctype="multipart/form-data">
                      <?php echo e(csrf_field()); ?>

                      <input type="hidden" name='horse_id' value="<?php echo e($horse->id); ?>" />
                  <div >
          ...
          <div class="col-md-6">
                  ...
                  <input type="text" class="form-control" name="name" value="<?php echo e($horse->name_en); ?>">
                </div>
                      <div class="col-md-6">
                  <label for="inputName5" class="form-label">Horse registration number</label>
                  <input type="text" class="form-control" name="reg_no" value="<?php echo e($horse->reg_no); ?>">
                </div>
                  ...
                  <select  class="form-control" name="gender">
                      <option value="stallion"  <?php echo e(strtolower($horse->gender) == 'stallion' ? 'selected' : ''); ?>>Stallion</option>
                      <option value="mare" <?php echo e(strtolower($horse->gender) == 'mare' ? 'selected' : ''); ?>>Mare</option>
               ...
               <div class="col-md-6">
                  ...
                  <input type="text" class="form-control" name="color"   value="<?php echo e($horse->color); ?>">
                </div>         
           ...
           <div class="col-md-6">
                  ...
                  <input type="text" class="form-control" name="breeder"  value="<?php echo e($horse->breeder_name); ?>">
                </div>   
                    
                         <div class="col-md-6">
                  <label for="inputName5" class="form-label">Owner</label>
                  <input type="text" class="form-control" name="owner" value="<?php echo e($horse->owner_name); ?>">
                </div>   
           
                    
                       <div class="col-md-6">
                  <label for="inputName5" class="form-label">Origin</label>
                  <input type="text" class="form-control" name="country" value="<?php echo e($horse->origin); ?>">
                </div>  
                  ...
                  <input type="file" class="form-control" name="passport_doc">
                   <?php if($horse->passport_doc != ""): ?>
                  <a href="<?php echo e(url('storage/'.$horse->passport_doc)); ?>" >View uploaded passport</a>
                    <?php endif; ?>
                </div>  
                  ...
                  <?php if($horse->veterinary != ""): ?>
                     <a href="<?php echo e(url('storage/'.$horse->veterinary)); ?>" >View uploaded document</a>
                     <?php endif; ?>
                </div>  
                  ...
                  <textarea  rows="5"  class="form-control"  name="about"><?php echo e($horse->about_horse); ?></textarea>
                </div>
...
<!--                    <form method="post" action="<?php echo e(url('operations/horses/update')); ?>" enctype="multipart/form-data">
                ...
                <div class="card  p-2" >
                      ...
                      <p>Gallery</p>
                      <form method="post" id="delete-form" action="<?php echo e(url('operations/horses-gallery/delete')); ?>">   
                        <?php echo e(csrf_field()); ?>
                   ...
                   <div class="plus-button" >
                       <img src="<?php echo e(url('storage/horses-gallery/'.$m->media_link)); ?>" /><br />
    ...
    color: green;"></p>
                    ...
                    <div class="card  p-2" >
                      ...
                      <table class="table table-bordered " >
                         ...
                         foreach (    $records as $m){ ?>
                            ...
                            <tr>
                                <td><?php echo e($m->horse_name); ?></td>
                                <td><?php echo e($m->comp_name); ?></td>
                                <td><?php echo e($m->relation_name); ?></td>
                                <td><?php echo e($m->rank_name); ?></td>
                                <td><?php echo e($m->rank_name); ?></td>
                                <td>
                                    
                                    
                                     <form method="post" id="delete-form" action="<?php echo e(url('operations/horses/performance/delete')); ?>">   
                        <?php echo e(csrf_field()); ?>
                  ...
                  <?php } ?>
                            ...
                            <tr>
                                ...
                                <form method="post" action="<?php echo e(url('operations/horses/performance/add')); ?>" >
                      <?php echo e(csrf_field()); ?>
              ...
              <div class="card  p-2" >
                  ...
                  <p>Seller information</p>
                       ...
                       <table class="table table-bordered">
                           <tr>
                               <th>Seller name</th>
                               <td><a style="font-weight: bold" target="blank" href="<?php echo e(url('users/'.$seller->id)); ?>"><?=$seller->name?></a></td>
...
<?php }else echo "Not allowed to access this page"; ?><?php /**PATH C:\wamp64\www\test\resources\views/dashboard/pages/horses-single.blade.php ENDPATH**/ ?>