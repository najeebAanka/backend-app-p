...
<body>
    ...
    <main id="main" class="main">
        ...
        <div class="bg-trans p-2">
            ...
            <?php if($currentUser->can('create-auctions')): ?>
         ...
         foreach ( $data  as $u){
             ...
             ?>
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
                    <a href="<?php echo e(url('auctions/' . $u->id)); ?>" style="color: #000">
...
background-color: #F44336;
    ...
    padding: 0.7rem;
  ">
                                    <?php if($currentUser->isAdmin()): ?> Not published
                                        <i> (<?= App\Models\HorseRegRequest::where('status', 'pending')
                                            ->where('auction_id', $u->id)
                                            ->count() ?> requests)</i>
                                    <?php else: ?>
                                        <?php if(\Carbon\Carbon::now()->between($u->entry_start_datetime, $u->entry_end_datetime)): ?>
                ...
                <?php if($currentUser->can('create-auctions')): ?>
                    <div class="modal fade" id="ExtralargeModal" tabindex="-1">
                        <div class="modal-dialog modal-xl">
                            <form method="post" id="identifier" action="<?php echo e(url('operations/auctions/create')); ?>"
...
<?php /**PATH C:\wamp64\www\test\resources\views/dashboard/pages/auctions.blade.php ENDPATH**/ ?>